      ...
      <div className="hidden md:flex items-center gap-2">
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="max-w-[120px] truncate">{settings.default_model}</span>
              ...
              >
                <div className="p-2">
                  ...
                  {availableModels.length === 0 ? (
                    <p className="text-xs text-muted-foreground px-2 py-2">No models found</p>
                  ) : (
        ...
        <div className="relative">
          ...
          >
            ...
            <span className="max-w-[120px] truncate">{settings.vision_model}</span>
            <ChevronDown className="w-3 h-3 text-muted-foreground" />
          </button>
